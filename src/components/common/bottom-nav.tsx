...
import {Home, IndianRupee, LayoutPanelLeft, Map, PenSquare} from 'lucide-react';
...
export default function BottomNav() {
    ...
    return (
        <div
            className="lg:hidden fixed bottom-0 left-0 right-0 h-14 xs:h-16 sm:h-18 bg-card border-t border-border z-50 safe-area-inset-bottom">
