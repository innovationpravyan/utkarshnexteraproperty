...
export const PROJECTS: Project[] = [
    {
        ...
        imageUrl: "/project/banglore/modern villa in sarjapur.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/gurugram/Luxury Duplex on Golf Course Road.jpeg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/varanasi/ghat view apartment.jpg", // Updated
    ...
    },
    {
        id: 4,
        category: "Renovation",
        title: "Historic Haveli Restoration, Gurudham colony",
        ...
        imageUrl: "/project/varanasi/Hestorical haveli restoration, shivala ghat.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/gurugram/Suburban Family Home, Sohna Road.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/banglore/Minimalist Cafe Design, Koramangala.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/banglore/Eco-Friendly Office, Electronic City.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/gurugram/Bathroom Remodel, DLF Phase 3.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/varanasi/Boutique retail store, lanka.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/banglore/modern farmhouse, whitefield.jpg", // Updated
    ...
    },
    {
        ...
        imageUrl: "/project/varanasi/Ghat side guest house.jpg", // Updated
...
// TESTIMONIALS - Replace placeholder URLs with actual image paths
export const TESTIMONIALS: Testimonial[] = [
    ...
    { name: 'Dr. Arvind Rai', city: 'Gurugram', text: "We looked at so many apartments, but nothing felt like home. utkarsh next era built us a home that feels like it was made just for us.", rating: 5, image: "/happy_customers/happy_customers(2).jpg", package: "Premium Package", crn: "62781", year: 2024, projectType: "5BHK Duplex Construction" },
...
const cityPackagePrices: Record<string, Record<PackageType, Record<Package['name'], number>>> = {
    ...
    "Varanasi": {
        "Homes": { Basic: 1700, Classic: 1880, Premium: 2250, Royale: 2485, Luxe: 0, Elegance: 0, Opulence: 0, Imperial: 0 }, // Fixed Basic price
...
export const BlogPosts = [
    {
        ...
        image: "/blogs/Top 10 Home Renovation Trends for 2025 .png", // Updated
        author: "Priya Sharma",
        date: "March 15, 2025",
    ...
    },
    {
        ...
        image: "/blogs/Sustainable Construction Building for the Future.png", // Updated
        author: "Arjun Patel",
        date: "March 10, 2025",
    ...
    },
    {
        ...
        image: "/blogs/Smart Home Integration in New Constructions.png", // Updated
        author: "Kavya Reddy",
        date: "March 5, 2025",
        category: "Technology",
    ...
    },
    {
        ...
        image: "/blogs/Budget-Friendly Kitchen Renovation Ideas.png", // Updated
        author: "Rohit Gupta",
    ...
    },
    {
        ...
        image: "/blogs/The Ultimate Guide to Bathroom Remodeling.png", // Updated
        author: "Ananya Singh",
    ...
    },
    {
        ...
        image: "/blogs/Energy-Efficient Building Materials A Complete Guide.png", // Updated
        author: "Vikram Nair",
...
export const CLOSER_LOOK_DATA: CloserLookPackage[] = [
    {
        name: "Basic",
        mainImage: "/closer_look/basic_package.jpg", // Updated
    ...
    {
        name: "Classic",
        mainImage: "/closer_look/classic package.jpg", // Updated
    ...
    {
        name: "Premium",
        mainImage: "/closer_look/premium package.jpg", // Updated
    ...
    {
        name: "Royale",
        mainImage: "/closer_look/The%20Ultimate%20in%20Luxu.png", // Updated
...
export type PropertyForSale = {
    ...
    location: string;
    price: number;
    imageUrl: string; // Will be the primary image
    images: string[];
    aiHint: string;
    tag?: string;
    details: {
...
export const PROPERTIES_FOR_SALE: PropertyForSale[] = [
    {
        id: 1,
        title: "Residential Plot in Babatpur",
        location: "Babatpur, Varanasi",
        price: 3580000,
        imageUrl: "https://placehold.co/600x400.png",
        images: ["https://placehold.co/600x400.png", "https://placehold.co/600x400.png", "https://placehold.co/600x400.png"],
        aiHint: "residential plot land",
        details: { plotArea: 1200, breadth: 30, length: 40, facing: 'East', listedBy: 'Owner' },
        description: "A prime residential plot located in the rapidly developing area of Babatpur. Perfect for building your dream home. Close to the airport and main city.",
        seller: defaultSeller
    },
    {
        id: 2,
        title: "Main Road Plot in Ramnagar",
        location: "Ramnagar, Varanasi",
        price: 17350000,
        imageUrl: "https://placehold.co/600x400.png",
        images: ["https://placehold.co/600x400.png", "https://placehold.co/600x400.png"],
        aiHint: "roadside plot land",
        tag: "SALE",
        details: { plotArea: 2500, breadth: 50, length: 50, facing: 'West', listedBy: 'Agent' },
        description: "Excellent opportunity for commercial or residential use. This plot is situated on the main road in Ramnagar, offering high visibility and easy access.",
        seller: defaultSeller
    },
    {
        id: 3,
        title: "Corner Plot in Shivpur",
        location: "Shivpur, Varanasi",
        price: 1590000,
        imageUrl: "https://placehold.co/600x400.png",
        images: ["https://placehold.co/600x400.png", "https://placehold.co/600x400.png", "https://placehold.co/600x400.png"],
        aiHint: "corner plot empty",
        details: { plotArea: 1000, breadth: 25, length: 40, facing: 'North', listedBy: 'Owner' },
        description: "Beautiful corner plot in a peaceful residential colony in Shivpur. Two-side open, ideal for a well-ventilated and bright home.",
        seller: defaultSeller
    },
    {
        id: 4,
        title: "Commercial Land in Sarnath",
        location: "Sarnath, Varanasi",
        price: 20000000, // Price corrected
        imageUrl: "https://placehold.co/600x400.png",
        images: ["https://placehold.co/600x400.png"],
        aiHint: "commercial land empty",
        details: { plotArea: 5000, breadth: 50, length: 100, facing: 'East', listedBy: 'Agent' },
        description: "Large commercial land parcel in the historic area of Sarnath. Suitable for hotels, guesthouses, or other commercial establishments.",
        seller: defaultSeller
    },
    {
        id: 5,
        title: "Farmhouse Land near Ganga",
        location: "Kachhwa, Varanasi",
        price: 9500000, // Price corrected
        imageUrl: "https://placehold.co/600x400.png",
        images: ["https://placehold.co/600x400.png", "https://placehold.co/600x400.png"],
        aiHint: "farmhouse land field",
        details: { plotArea: 10000, breadth: 100, length: 100, facing: 'South', listedBy: 'Owner' },
        description: "Expansive land perfect for a farmhouse or agricultural project, located in a serene environment near the Ganga river.",
        seller: defaultSeller
    },
    {
        id: 6,
        title: "Gated Community Plot",
        location: "Mohansarai, Varanasi",
        price: 1620000,
        imageUrl: "https://placehold.co/600x400.png",
        images: ["https://placehold.co/600x400.png"],
        aiHint: "gated community plot",
        details: { plotArea: 900, breadth: 30, length: 30, facing: 'West', listedBy: 'Agent' },
        description: `40ft and 30ft wide 28ft wide road
Park
Sewerage
Pole
24x7 Security Guard
Temple (Gated Township)`,
        seller: defaultSeller
    },
    // Add more properties with new fields...
    { id: 7, title: "Plot with Old Structure", location: "DLW Colony, Varanasi", price: 3690000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "plot old building", details: { plotArea: 1500, breadth: 30, length: 50, facing: 'North', listedBy: 'Owner' }, description: "Plot with an existing old structure, located in the well-established DLW Colony. Ideal for redevelopment.", seller: defaultSeller },
    { id: 8, title: "Ready to Build Plot", location: "Pandeypur, Varanasi", price: 3590000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "empty plot ready", details: { plotArea: 1350, breadth: 30, length: 45, facing: 'East', listedBy: 'Agent' }, description: "A clear, ready-to-build plot in Pandeypur with all necessary clearances. Start your construction immediately.", seller: defaultSeller },
    { id: 9, title: "Large Agricultural Land", location: "Mirzamurad, Varanasi", price: 15000000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "agricultural land field", details: { plotArea: 20000, breadth: 100, length: 200, facing: 'South', listedBy: 'Owner' }, description: "Fertile agricultural land suitable for various crops. Located in Mirzamurad with good road access.", seller: defaultSeller },
    { id: 10, title: "Investment Plot on Ring Road", location: "Harpalpur, Varanasi", price: 5000000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "plot near highway", details: { plotArea: 1800, breadth: 40, length: 45, facing: 'West', listedBy: 'Agent' }, description: "High-potential investment plot on the upcoming Ring Road. Expected to appreciate significantly.", seller: defaultSeller },
    { id: 11, title: "Varanasi Urban Plot", location: "Lahartara, Varanasi", price: 714000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "urban plot city", details: { plotArea: 600, breadth: 20, length: 30, facing: 'North', listedBy: 'Owner' }, description: "Compact urban plot in Lahartara, suitable for a small family home or commercial shop.", seller: defaultSeller },
    { id: 12, title: "Riverside Plot with View", location: "Samne Ghat, Varanasi", price: 6500000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "riverside plot", details: { plotArea: 1000, breadth: 25, length: 40, facing: 'East', listedBy: 'Owner' }, description: "Rare plot with a direct, unobstructed view of the Ganga river at Samne Ghat. Perfect for a serene home or guesthouse.", seller: defaultSeller },
    { id: 13, title: "Plot near BHU Campus", location: "Lanka, Varanasi", price: 17000000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "plot near university", details: { plotArea: 1500, breadth: 30, length: 50, facing: 'North', listedBy: 'Agent' }, description: "Prime location plot very close to the BHU campus. Ideal for residential or rental income purposes.", seller: defaultSeller },
    { id: 14, title: "Industrial Area Plot", location: "Karsana, Varanasi", price: 1403000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "industrial plot empty", details: { plotArea: 3000, breadth: 50, length: 60, facing: 'West', listedBy: 'Agent' }, description: "Plot located in the designated industrial area of Karsana, suitable for setting up a small to medium scale enterprise.", seller: defaultSeller },
    { id: 15, title: "Plot in Developing Area", location: "Rohaniya, Varanasi", price: 2240000, imageUrl: "https://placehold.co/600x400.png", images: ["https://placehold.co/600x400.png"], aiHint: "developing area plot", details: { plotArea: 1200, breadth: 30, length: 40, facing: 'East', listedBy: 'Owner' }, description: "Affordable plot in the rapidly developing Rohaniya area. A great investment for future growth.", seller: defaultSeller },
];
